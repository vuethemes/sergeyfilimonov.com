<template>
  <div class="bg-theme-backgroundGray p-4 lg:p-4 mt-5">
    <div class="font-bold text-xs text-theme-textSecondary mb-2">
      Технологии онлайн-продвижения
    </div>
    <ul>
      <li class="flex items-center mb-2">
        <div class="w-5 h-5 rounded-full mr-2 flex items-center justify-center leading-none"><i class="fab fa-youtube text-social-youtube"></i></div>YouTube
      </li>
      <li class="flex items-center mb-2">
