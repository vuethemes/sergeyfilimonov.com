<template>
  <div class="bg-theme-backgroundGray p-4 lg:p-6 mt-6">
    ...
    <a href="https://www.youtube.com/channel/UCoj3nHKZm6r2acowfEwSFww?view_as=subscriber" rel="nofollow noreferrer noopener" class="link text-social-youtube border-social-youtube" target="_blank">Все уроки на YouTube</a>
  </div>
</template>
