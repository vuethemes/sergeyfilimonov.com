      ...
      <div class="lg:mt-8 mb-4">
        ...
        <div class="markdown">
          <ul>
            ...
            <li><g-link to="/tools/tailwind" class="link">Компоненты для Tailwind</g-link></li>
          </ul>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      meta: {
        title: 'Инструменты для маркетологов и разработчиков',
        description: 'UTM-генератор ссылок, компонтенты для Tailwind и другое'
      }
    }
  },
  metaInfo() {
